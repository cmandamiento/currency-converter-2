...
describe("AppComponent", () => {
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [AppComponent, USDComponent, YenComponent],
      imports: [FormsModule],
    }).compileComponents();
  }));
  ...
  it("should pass data between components", () => {
    ...
    const yen = fixture.debugElement.query(By.css("textarea#yen"))
      .nativeElement;
    console.log(yen);
    yen.value = "123";
    fixture.detectChanges();
    ...
    fixture.whenStable().then(() => {
      const usd = fixture.debugElement.query(By.css("textarea#usd"))
        .nativeElement;
